...
BeeWare's documentation is written using `Sphinx and reStructuredText
...
To build BeeWare's documentation, start by :ref:`setting up a development environment
<setup-dev-environment>`.

You **must** have a Python 3.12 interpreter installed and
...
a gap in BeeWare's documentation, or an improvement that can be made, start
